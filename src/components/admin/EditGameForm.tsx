...
import { ArrowLeft, Trash2, PlusCircle, Palette, Gift, Eye, Image as ImageIcon, FileText, Settings, GripVertical, Cog } from 'lucide-react';
...
const segmentSchema = z.object({
  option: z.string().min(1, 'El nombre del premio no puede estar vacío.'),
  style: z.object({
...
const formSchema = z.object({
  ...
  segments: z.array(z.object({ name: z.string() })).min(2, 'Se necesitan al menos 2 premios para la ruleta.'),
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                                    ...
                                    <SortableItem key={field.id} id={field.id}>
                                      {(listeners) => (
                                        <div className="flex items-center gap-2 p-1 pr-2 border rounded-md bg-background hover:bg-muted/50">
                                            <Button type="button" {...listeners} className="cursor-grab p-1 flex-shrink-0" variant="ghost">
              ...
              <TabsContent value="wheel">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Ajusta el aspecto visual de la ruleta.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-8">
                     <div className="flex justify-center items-center p-4 bg-gray-100 dark:bg-gray-800 rounded-md">
                        <Wheel
        ...
        <Card 
            className="lg:col-span-1 sticky top-4 overflow-hidden"
            style={{
